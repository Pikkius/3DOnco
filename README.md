...
Results are shown in the table belows. 


Since we are utilizinf the one channel matrix for the classification, this means that the pattern under analysis can be visualized as an image.
